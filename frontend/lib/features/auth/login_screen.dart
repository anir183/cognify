          ...
          Center(
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  Text("COGNIFY", style: AppTheme.headlineLarge.copyWith(color: AppTheme.primaryCyan, letterSpacing: 4))
                      .animate()
                      .fadeIn(duration: 500.ms)
                      .slideY(begin: -0.2, end: 0),
                  const SizedBox(height: 8),
                  Text("Level Up Your Mind", style: AppTheme.bodyMedium.copyWith(color: AppTheme.textGrey))
                      .animate()
                      .fadeIn(delay: 200.ms),
                        ...
                        children: [
                          ...
                          Center(
                            child: TextButton(
                              ...
                              child: Text("Don't have an account? Sign Up", style: TextStyle(color: AppTheme.textGrey)),
                            ),
                          ),
                        ],
                      ),
